...
#Sample Generation
SAMPLES = tables[9]
SAMPLES['expsample_reference_id'] = df_bios['REPOSITORY_ACCESSION'] #df_bios['EXPSAMPLE_ACCESSION']
SAMPLES['sample_id'] = Reindex(SAMPLES)
...
SAMPLES['T0_definition'] = df_bios['STUDY_TIME_T0_EVENT']
...
SAMPLES['expsample_reference_name'] = 'GEO'
#SAMPLES2 = SAMPLES
#SAMPLES2['expsample_reference_id'] = df_bios['EXPSAMPLE_ACCESSION']
#SAMPLES2['expsample_reference_id'] = df_bios['EXPSAMPLE_ACCESSION']
...
EXPER['reference_id'] = EXPER['reference_id']
...
df_ir = df_ir[df_ir['SUBJECT_ACCESSION'].isin(SAMPLES['organism_id'])]

INTER['reference_id'] = pd.concat([df_ir['SUBJECT_ACCESSION']])
INTER['material_name'] = pd.concat([df_ir['EXPOSURE_MATERIAL_REPORTED']])
...
ORGO = ORGO[ORGO['organism_id'].isin(SAMPLES['organism_id'])]
...
GROUPS = tables[10]
GROUPS['experiment_id'] = EXPER['reference_id']
...
viget['biosample_id'] = SAMPLES['biosample_reference_id']
viget['biosample_type'] = SAMPLES['biosample_type']
viget['subtype'] = None
viget['immport_biosample_accession'] = SAMPLES['biosample_reference_id']
viget['expsample_repository_name'] = 'GEO'
viget['gsm'] = SAMPLES['expsample_reference_id']

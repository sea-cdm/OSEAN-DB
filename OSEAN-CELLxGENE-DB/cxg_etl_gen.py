...
# Authors will have to define author metadata speciic entries in seperate version; this only provides a generic version that works with all CellxGene studies.
...
def SEA_INIT():
    ...
    SEA_Occr  = pd.DataFrame(columns=['occurence_id','organism_id','occurence_name','occurence_type_id','occurence_severity','occurence_start_time','occurence_start_unit', 'occurence_start_id', 
...
DOCU = SEATemplates[1]
DOCU['reference_id'] = studyname
DOCU['reference_source'] = 'CellxGene'
...
OCCUR['organism_id'] = vadata['donor_id']
OCCUR['occurence_type'] = vadata['disease']
OCCUR['occurence_type_id'] = vadata['disease_ontology_term_id']
SEATemplates[8] = ONTO.set_index('ontology_id')
